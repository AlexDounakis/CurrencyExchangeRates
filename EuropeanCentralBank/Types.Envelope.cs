...
namespace EuropeanCentralBank
{
    ...
    //{
    //    [XmlElement(Namespace = "subject")]
    //    public string? Subject { get; }
    //    [XmlElement(Namespace = "Sender")]
    //    public string? Sender { get; }
    //    [XmlElement(Namespace = "Cube")]
    //    public IEnumerable<RatesResponse>? Response { get; }
    //    public Envelope(string subject , string sender , IEnumerable<RatesResponse> cube)
    //    {
    ...
    [System.Xml.Serialization.XmlRootAttribute(Namespace = "http://www.gesmes.org/xml/2002-08-01", IsNullable = true)]
